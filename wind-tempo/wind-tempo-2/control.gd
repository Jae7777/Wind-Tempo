...
# Path constants for all scenes
const MAIN_MENU_SCENE_PATH = "res://track selection/start.tscn" 
const EASY_TRACKS_PATH = "res://track selection/easy.tscn"  # <-- NEW
const NORMAL_TRACKS_PATH = "res://track selection/normal.tscn" # <-- NEW (Placeholder for now)
const HARD_TRACKS_PATH = "res://track selection/hard.tscn"    # <-- NEW (Placeholder for now)
...
# --- NEW BUTTON HANDLERS (Direct Selection Logic) ---
...
func _on_normal_pressed() -> void:
	current_index = 1 # Index 1 = "Normal"
	select_difficulty() # This calls save_settings() and loads tracks

func _on_hard_pressed() -> void:
	current_index = 2 # Index 2 = "Hard"
	select_difficulty() # This calls save_settings() and loads tracks
